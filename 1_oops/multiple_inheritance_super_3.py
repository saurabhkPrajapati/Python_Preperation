...
class Circle:
    def __init__(self, color="Blue", radius=2, **kwargs):
        print("Circle init")
        super().__init__(**kwargs)
        self.color = color
        print("Cou>>>>>>>>>>>>.", self.color)
        self.radius = radius

class Square:
    "Colour Will become yellow for this one only"
    def __init__(self, color="Yellow", side_length=3, **kwargs):
        print("Square init")
        super().__init__(**kwargs)
        self.color = color
        print("Cou>>>>>>>>>>>>.", self.color)
...
class ColoredCircle(Circle, Square):
    """Initialiazing colour inside Circle and Square classes and removing from ColoredCircle"""
...
print(ColoredCircle(radius=5, side_length=10, color="Red"))
