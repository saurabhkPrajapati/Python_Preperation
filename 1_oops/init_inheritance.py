...
# Old-style classes: These were the default in Python 2 if you defined a class without explicitly inheriting from object. For example:

class Employee:  # Old-style class in Python 2
    pass


# New-style classes: Introduced in Python 2.2, they are created by explicitly inheriting from the built-in object class. For example:
